    ...
    <svg aria-hidden="true" {...props}>
      <defs>
        ...
        <linearGradient id={`${id}-gradient`}>
          <stop offset="5%" stopColor="#c3a9dd" />
          <stop offset="10%" stopColor="#b697d5" />
          <stop offset="20%" stopColor="#aa84ce" />
          <stop offset="30%" stopColor="#9d72c7" />
          <stop offset="40%" stopColor="#905fc0" />
          <stop offset="50%" stopColor="#844db8" />
          <stop offset="60%" stopColor="#7743a9" />
          <stop offset="70%" stopColor="#6a3c97" />
          <stop offset="80%" stopColor="#502d72" />
          <stop offset="90%" stopColor="#502d72" />
        </linearGradient>
        <mask id={`${id}-mask`}>
