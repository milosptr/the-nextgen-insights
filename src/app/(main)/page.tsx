      ...
      <Container>
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
          ...
          <div className="flex flex-1 flex-col items-start">
            ...
            />
            <div
              className="mt-1 line-clamp-3 text-base leading-7 text-slate-700"
              dangerouslySetInnerHTML={{ __html: episode.description }}
            />
            <div className="mt-4 flex items-center gap-4">
              <EpisodePlayButton
                episode={episode}
                className="flex items-center gap-x-3 text-sm font-bold leading-6 text-primary hover:text-secondary active:text-indigo-900"
                playing={
                  <>
              ...
              <Link
                href={`/${episode.id}`}
                className="flex items-center text-sm font-bold leading-6 text-primary hover:text-secondary active:text-indigo-900"
