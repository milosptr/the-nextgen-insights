...
export default function MainLayout({
  ...
  let hosts = ['The NextGen Insights']
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:px-8 lg:py-12 xl:px-12">
          ...
          <div className="mt-10 text-center lg:mt-12 lg:text-left">
            <p className="text-xl font-bold text-slate-900">
              <Link href="/">The NextGen Insights</Link>
            </p>
            <p className="mt-3 text-lg font-medium leading-8 text-slate-700">
              Explore how today’s tech trends will shape tomorrow’s world, all
              in bite-sized, easy-to-digest insights.
            </p>
          </div>
              ...
              {(
                [
                  [
                    'Spotify',
                    SpotifyIcon,
                    'https://open.spotify.com/show/48wRAANT8mdr2AADmntFcx',
                  ],
                  [
                    'Apple Podcast',
                    ApplePodcastIcon,
                    'https://podcasts.apple.com/us/podcast/the-nextgen-insights/id1775464274',
                  ],
